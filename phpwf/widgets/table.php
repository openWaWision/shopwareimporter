    ...
    for($i=0;$i<$rows;$i++) {
      ...
      for($j=0;$j<$cols;$j++) {
        ...
        if($j==($col-1)){
          ...
          $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_history.gif\" border=\"0\" alt=\"Historie\">"; 
          $menu .= "</a>&nbsp;"; 

          // bearbeiten wenn aktiv
          if ($this->table->Table[$i][1] != 0) {
            $menu .= "<a href=\"index.php?module=".$module."&action=edit&id=$id\">"; 
            $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_edit.gif\" border=\"0\" alt=\"bearbeiten\">"; 
            $menu .= "</a>&nbsp;"; 
          } // end of if
          ...
          if (($this->table->Table[$i][1] == 0) && ($showActivate)){
            ...
            $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_reactivate.gif\" border=\"0\" alt=\"reaktivieren\">"; 
            $menu .= "</a>&nbsp;"; 
          } else {
            if($showActivate) {
              $menu .= "<a href=\"index.php?module=".$module."&action=deactivate&id=$id&order=[ORDER]\">"; 
              $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_deactivate.gif\" border=\"0\" alt=\"deaktivieren\">"; 
              $menu .= "</a>&nbsp;"; 
            } // end of if
          ...
          if ($showDelete) {
            ...
            if ($this->table->Table[$i][2] == 1) {
              ...
              $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_delete.gif\" border=\"0\" alt=\"l&ouml;schen\">"; 
              $menu .= "</a>&nbsp;"; 
      ...
      for($j=0;$j<$cols;$j++) {
        ...
        if($j==($col-1)){
          ...
          if ($this->table->Table[$i][3] != 0) {
            ...
            $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_view.gif\" border=\"0\" alt=\"Detailansicht\">"; 
            $menu .= "</a>&nbsp;"; 

            // Graph
            $menu .= "<a href=\"#\" onclick=\"GesamtGraphOrdnerID($id)\">"; 
            $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_statgraph.gif\" border=\"0\" alt=\"Graph\">"; 
            $menu .= "</a>&nbsp;"; 
    ...
    for($i=0; $i<$rows; $i++) {
      ...
      for($j=0; $j<$cols; $j++) {
        ...
        if($j==($col-1)){
          ...
          // Edit
          $menu .= "<a href=\"index.php?module=".$module."&action=edit&id=$id\">"; 
          $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_edit.gif\" border=\"0\" alt=\"Ordner bearbeiten\">"; 
          $menu .= "</a>&nbsp;"; 

          // Formeln bearbeiten
          $menu .= "<a href=\"index.php?module=".$module."formel&action=list&id=$id\">"; 
          $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_formeln.gif\" border=\"0\" alt=\"Formeln bearbeiten\">"; 
          $menu .= "</a>&nbsp;"; 

          // Nach unten (wenn nicht letztes in Liste)
          if ($i != $rows-1) {
            $menu .= "<a href=\"index.php?module=".$module."&action=movedown&id=$id\">"; 
            $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_down.gif\" border=\"0\" alt=\"Nach unten\">"; 
            $menu .= "</a>&nbsp;"; 
          } // end of if
          ...
          if ($i != 0) {
            ...
            $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_up.gif\" border=\"0\" alt=\"Nach oben\">"; 
            $menu .= "</a>&nbsp;"; 
          } // end of if
    ...
    for($i=0; $i<$rows; $i++) {
      ...
      for($j=0; $j<$cols; $j++) {
        ...
        if($j==($col-1)){
          ...
          if ($this->table->Table[$i][1] == 4 && $id != -1) {
            ...
            $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_ansicht_1_1.gif\" border=\"0\" alt=\"Ansicht Vollformat\">"; 
            $menu .= "</a>&nbsp;"; 
          } else if ($this->table->Table[$i][0] != "") {
            $menu .= "<a href=\"index.php?module=".$module."&action=viewquarter&id=$id\">"; 
            $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_ansicht_1_4.gif\" border=\"0\" alt=\"Ansicht Viertelformat\">"; 
            $menu .= "</a>&nbsp;"; 
	  ...
	  //echo $this->table->Table[$i][1]."<br>";
          ...
          if ($id != -1) {
            ...
            $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_add.gif\" border=\"0\" alt=\"Nach diesem hinzufügen\">"; 
            $menu .= "</a>&nbsp;"; 
          } else {
            $menu .= "<a href=\"index.php?module=".$module."&action=add&id=$id\">"; 
            $menu .= "<img src=\"./sip/themes/default/images/buttons/bu_add.gif\" border=\"0\" alt=\"Formel hinzufügen\">"; 
            $menu .= "</a>&nbsp;"; 
          } // end of if
